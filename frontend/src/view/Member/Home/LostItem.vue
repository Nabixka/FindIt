      ...
      <div class="px-6 text-center">
        ...
        <motion.div :initial="{ scale: 0.8, opacity: 0 }" :animate="{ scale: 1, opacity: 1 }" class="mt-6 flex flex-col items-center gap-6" >
          ...
          <div class="grid grid-cols-2 gap-3 w-full max-w-md p-1.5 bg-gray-200/50 rounded-2xl">
            <router-link to="/member/lost" active-class="bg-white shadow-md text-yellow-600" class="text-center py-2.5 rounded-xl font-bold text-gray-500 transition-all hover:text-yellow-600">
              Lost Item
            </router-link>

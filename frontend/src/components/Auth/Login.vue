        ...
        <div class="flex flex-col h-screen">
            ...
            <div class="pl-10 pr-10 mt-10 flex flex-col gap-5 bg-blue-900/80 h-full p-5 rounded-t-4xl">
                <form @submit.prevent="Login" class="flex flex-col gap-5 pt-10">
                    <div class="shadow-xl">
                        <input v-model="email" class="shadow text-white w-full pl-3 py-2 border-2 border-white rounded"
                            placeholder="Email">
                    </div>
                    <div class="shadow-xl">
                        <input v-model="password" class="shadow text-white w-full pl-3 py-2 border-2 border-white rounded"
                            placeholder="Password">
                    </div>
                    <div class="flex justify-center">
                        <button class="bg-yellow-400/90 py-2 px-15 rounded-lg font-semibold text-blue-800">LOG
                            IN</button>
                    </div>
                </form>
